...
export default function WhatsAppButton() {
    ...
    // Número de WhatsApp con código de país de Uruguay (+598)
    const phoneNumber = '+59899743492'; // Formato: código país + número sin espacios
    const message = 'Hola! Me gustaría consultar sobre sus servicios de alineación.';
    const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(message)}`;

    // Detener la animación después de 4 segundos (4 ciclos)
    useEffect(() => {
        const timer = setTimeout(() => {
            setShowPulse(false);
        }, 4000); // 4 segundos = 4 pulsos aproximadamente
    ...
    return (
        ...
        >
            ...
            {/* Pulse animation - solo primeros 4 segundos */}
            {showPulse && (
