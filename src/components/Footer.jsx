...
export default function Footer() {
    return (
        <footer className="bg-taller-blue text-white border-t-4 border-taller-red" id="contacto">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">

                    {/* Columna 1: Logo y descripción */}
                    <div className="space-y-4">
                        <h2 className="text-2xl font-bold border-b-2 border-taller-red pb-2 inline-block">Portela Alineaciones</h2>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start">
                                <MapPinIcon className="h-6 w-6 mr-3 flex-shrink-0 text-taller-red" />
                                <a
                                ...
                                >
                                    Wilson Ferreira Aldunate 1144, Montevideo, Uruguay
                                </a>
                            </li>
                            <li className="flex items-center">
                                <PhoneIcon className="h-5 w-5 mr-3 text-taller-red" />
                                <a href="tel:29032424" className="hover:text-taller-red transition-colors">29032424</a>
                            </li>
                            <li className="flex items-center">
                                <DevicePhoneMobileIcon className="h-5 w-5 mr-3 text-taller-red" />
                                <a href="tel:+59899743492" className="hover:text-taller-red transition-colors">099743492</a>
                            </li>
                            <li className="flex items-center">
                                <EnvelopeIcon className="h-5 w-5 mr-3 text-taller-red" />
                                <a href="mailto:alineacionesportela@gmail.com" className="hover:text-taller-red transition-colors">alineacionesportela@gmail.com</a>
                            </li>
                            <li className="flex items-center">
                                <ClockIcon className="h-5 w-5 mr-3 text-taller-red" />
                ...
                <div className="mt-8 border-t border-blue-800 pt-8 text-center text-gray-300">
                    <p>&copy; {new Date().getFullYear()} Taller de Alineación. Todos los derechos reservados.</p>
                </div>
            </div>
        </footer>
    );
